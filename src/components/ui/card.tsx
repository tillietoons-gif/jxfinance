...
export function Card({ className, ...props }: any) { const s = useStyles(); return <FluentCard className={mergeClasses(s.section, className)} {...props} />; }
export function CardHeader({ className, ...props }: React.ComponentProps<"div">) { const s = useStyles(); return <div className={mergeClasses(s.header, className)} {...props} />; }
