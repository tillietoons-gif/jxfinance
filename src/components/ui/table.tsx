...
export function Table({ className, ...props }: React.ComponentProps<typeof FluentTable>) { return <div role="region" aria-label="Scrollable table" tabIndex={0} style={{ overflowX: "auto", maxWidth: "100%" }}><FluentTable className={className} {...props} /></div>; }
