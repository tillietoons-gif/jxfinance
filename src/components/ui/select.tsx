  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        style={{ zIndex: 1000, backgroundColor: "var(--colorNeutralBackground1, #ffffff)", color: "var(--colorNeutralForeground1, #242424)", border: "1px solid var(--colorNeutralStroke1, #d1d1d1)", minWidth: "var(--radix-select-trigger-width)", maxHeight: "var(--radix-select-content-available-height)" }}
        className={cn(
          "bg-popover text-popover-foreground pointer-events-auto data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 relative z-[1000] max-h-[var(--radix-select-content-available-height)] min-w-[8rem] origin-[var(--radix-select-content-transform-origin)] overflow-x-hidden overflow-y-auto rounded-md border shadow-md",
          position === "popper" &&
      ...
      >
        ...
        <SelectPrimitive.Viewport
          style={{ width: "100%", minWidth: "var(--radix-select-trigger-width)" }}
          className={cn(
            "w-full min-w-0 p-1",
            position === "popper" &&
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground bg-popover text-popover-foreground pointer-events-auto [&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full cursor-pointer items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
